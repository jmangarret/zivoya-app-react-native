...
export default class Month extends Component {
  render() {
    ...
    const weeks = [];
    let startOfMonth = focusedMonth.clone().startOf('month').startOf('week'); // make startOfMonth is immutable
    let endOfMonth = focusedMonth.clone().endOf('month');                        // same logic as below
