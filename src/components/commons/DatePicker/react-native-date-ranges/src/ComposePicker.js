...
import {
  View, TouchableHighlight, Modal, Text, Alert
} from 'react-native';
    ...
    if (this.props.mode === "range") {
      ...
      return (<View style={{ marginTop: 25, justifyContent: 'space-between', alignContent: 'flex-start', flexDirection: 'row' }}>
        <View style={{ width: '45%' }}>
          <View pointerEvents="none">
            <Input value={inputStartDate.format('MM-DD-YYYY')} modeInput="flat" label={I18n.t('departure')} />
          </View>
          <Icon
            style={{
              position: 'absolute',
        ...
        <View style={{ width: '45%' }}>
          <View pointerEvents="none">
            <Input value={inputEndDate.format('MM-DD-YYYY')} modeInput="flat" label={I18n.t('return')} />
          </View>
          <Icon
            style={{
              position: 'absolute',
      ...
      return (<View style={{ marginTop: 25, justifyContent: 'space-between', alignContent: 'flex-start', flexDirection: 'row' }}>
        <View style={{ width: '100%' }}>
          <View pointerEvents="none">
            <Input value={inputStart.format('MM-DD-YYYY')} modeInput="flat" label={I18n.t('departure')} />
          </View>
          <Icon
            style={{
              position: 'absolute',
