          ...
          {this.props.mode === 'range' && 
            <View>
              ...
              <View style={styles.dateContainer}>
                <Text style={headerDate}>{this.state.clearStart ? this.state.clearStart : I18n.t('departureDate')}</Text>
                <Text style={{  fontSize: normalize(17), color: 'white', fontWeight: 'normal' }}>→</Text>
                <Text style={headerDate}>{this.state.clearEnd ? this.state.clearEnd : I18n.t('returnDate')}</Text>
              </View>
            </View>
          }
        </View>
